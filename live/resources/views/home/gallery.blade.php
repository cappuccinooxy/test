...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>全直播</title>
	<meta name="description" content="全直播">
	<meta name="author" content="黄捷龙">
...
<div class="wrap-body">
	...
	<header>
		...
		<div class="bottom">
			<div class="zerogrid">
				<div class="row">
					<span>合作平台：<a href="https://www.douyu.com/" target="_blank">斗鱼TV</a>　<a href="http://www.quanmin.tv/" target="_blank">全民TV</a>  <a href="https://www.zhanqi.tv/" target="_blank">战旗TV</a>　<a href="http://www.panda.tv/" target="_blank">熊猫TV</a>　<a href="http://www.huya.com/" target="_blank">虎牙TV</a></span>
				</div>
			</div>
		</div>
    </header>
    ...
    <nav class="cmn-tile-nav">
		<ul class="clearfix">
			<li class="colour-1"><a href="gallery.html">英雄联盟</a></li>
	...
	<section id="container" class="index-page">
		<div class="wrap-container zerogrid">
			<div class="row">
				<div id="main-content" class="col-3-7">
					<section class="all">
						<div class="header">
							<h2>All Post</h2>
						</div>
